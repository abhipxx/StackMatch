    ...
    return(
        ...
        <div className="min-h-screen bg-blue-900 flex items-center justify-center">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button type="submit" className="w-full bg-blue-500 hover:bg-blue-600 text-white py-2 rounded-lg font-medium transition">SUBMIT</button>
                <p className="text-center mt-4 text-gray-600"> Do not have an account?<Link to="/register" className="text-blue-500 hover:underline">Register</Link></p>
            </form>
            </div>
        </div>
        </>
